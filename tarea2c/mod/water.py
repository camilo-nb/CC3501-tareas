...
class Water():
    def __init__(self):
        self.GPU = es.toGPUShape(oh.readOBJ2(os.path.join('mod','tex','water.obj'), os.path.join('mod','tex','water.png')), GL_REPEAT, GL_NEAREST)
        self.s = 125
        self.x,self.y, self.z = 0, 0, -self.s-5
