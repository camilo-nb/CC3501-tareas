...
class Camera():
    ...
    def __init__(self):
        ...
        self.camera = 0 # 0:my_view, 1:top_view, 2:diagonal_view, 3:game_over_view
    ...
    def view(self):
        ...
        elif self.camera == 3: return tr.lookAt(np.array([0, 300, 125]), np.array([0, 350, 0]), np.array([0, 0, 1]))
    ...
    def game_over_view(self): self.camera = 3